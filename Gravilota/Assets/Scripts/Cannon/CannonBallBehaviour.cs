...
public class CannonBallBehaviour : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        gameObject.transform.Translate(_currentSpeed * Time.deltaTime + 
        Physics.gravity * Mathf.Pow(Time.deltaTime, 2) / 2);
    ...
    public void Shoot (float triggerSpeed, float triggerAngle )
    {
        ...
        _currentSpeed = new Vector3(triggerSpeed * Mathf.Cos(triggerAngle), 
